...
import dinner_menu_results from "./DB_offline_by_the_menu/core_in_use/dinner_menu_results.json";
import appetizer_menu_results from "./DB_offline_by_the_menu/core_in_use/appetizer_menu_results.json";
import brunch_menu_results from "./DB_offline_by_the_menu/core_in_use/brunch_menu_results.json";
import dessert_menu_results from "./DB_offline_by_the_menu/core_in_use/dessert_menu_results.json";
import drink_menu_results from "./DB_offline_by_the_menu/core_in_use/drink_menu_results.json";

export default function MenusDB(menu_name) {
    const dinner_menu = dinner_menu_results;
    // [
    //     {
    //         id: 24,
    ...
    const drink_menu = drink_menu_results;
    //  [
    //     {
    //         id: 4,
    //         name: "Whitney",
    ...
    const appetizer_menu = appetizer_menu_results;
    ...
    const brunch_menu = brunch_menu_results;
    // [
    //     {
    //         id: 4,
    ...
    const dessert_menu = dessert_menu_results;
